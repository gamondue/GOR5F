...
<node CREATED="1421926947131" ID="ID_962405130" MODIFIED="1421926949052" TEXT="es.">
<node CREATED="1421662886193" ID="ID_712172699" MODIFIED="1421663041471" TEXT="git config --global http.proxy http://gabriele.monti:PasswordDiMontiInChiaro@hagrid:8080"/>
<node CREATED="1421662886193" ID="ID_105211891" MODIFIED="1421668453514" TEXT="git config --global https.proxy https://gabriele.monti:PasswordDiMontiInChiaro@hagrid:8080">
<node CREATED="1421663055038" ID="ID_1357556984" MODIFIED="1421663075843" TEXT="uguale a prima, solo che https sostituisce http"/>
</node>
</node>
</node>
</node>
...
<node CREATED="1421663839781" ID="ID_1646885420" MODIFIED="1421668964163" TEXT="Clonare un repository">
...
<node CREATED="1421924146698" ID="ID_1058836499" MODIFIED="1421924158190" TEXT="Dobbiamo copiare dalla chiavetta e sincronizzare in seguito solo le differenze. ">
...
<node CREATED="1421925612037" ID="ID_193285669" MODIFIED="1421926986735" TEXT="Sincronizzare il git remoto (su GitHub) al git locale (sul computer su cui si lavora)">
<node CREATED="1421925725430" ID="ID_548482024" MODIFIED="1421925737450" TEXT="da Git bash"/>
<node CREATED="1421926990085" ID="ID_1737714881" MODIFIED="1421926990085" TEXT=""/>
</node>
</node>
</node>
