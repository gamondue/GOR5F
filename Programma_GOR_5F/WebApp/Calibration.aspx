...
<body>
    ...
    <div style="height: 341px; width: 838px">
        ...
        <asp:Label ID="lblNomeSensore" runat="server" Text="NomeSensore" style="position:absolute; left:292px; top:56px; width: 144px; height: 19px;"></asp:Label>  
        ...
        <asp:Label ID="lblUnitàDiMisura" runat="server" Text="UnitàMisura" style="position:absolute; left:290px; top:106px; width: 84px; height: 19px;"></asp:Label>
        ...
        <asp:Label ID="lblUnitàMisuraPuntoUno" runat="server" Text="UnitàMisura" style="position:absolute; left:420px; top:250px; width: 84px; height: 19px;"></asp:Label>
        <asp:Label ID="lblUnitàMisuraPuntoDue" runat="server" Text="UnitàMisura" style="position:absolute; left:420px; top:300px; width: 84px; height: 19px;"></asp:Label>
