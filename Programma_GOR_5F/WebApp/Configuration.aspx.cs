...
public partial class ConfigPage : System.Web.UI.Page
{
    ...
    protected void btnSalva_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (rdbTemperature.Checked == true && txtIdCircuitoIntegratoTemp.Text != "")
            {
            ...
            if (rdbGroundHumidity.Checked == true)
            {
            ...
            if ((rdbHIH4000.Checked && txtCanaleHIH.Text != null) || (rdbGroundHumidity.Checked && txtCanaleGround.Text != null)
                || (rdbLux.Checked && txtCanaleLux.Text != null) || (rdbTemperature.Checked && txtIdCircuitoIntegratoTemp.Text != null))
            {
