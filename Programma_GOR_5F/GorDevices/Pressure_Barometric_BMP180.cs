...
{
    public class BarometricPressure_BMP180 : Sensor
    {
        // Calibration data.
        private short ac1;
        private short ac2;
        ...
        public BarometricPressure_BMP180() : base(true)
        {

        }

        public BarometricPressure_BMP180(int deviceAddress, I2cDriver driver) : base(false)
        {
