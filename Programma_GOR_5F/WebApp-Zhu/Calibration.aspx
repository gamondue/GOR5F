...
<body style="background-image: url('Image/Sfondo.jpg'); height: 389px; width: 999px;">
    ...
    <div style="height: 395px; width: 1001px">
        ...
        <br />
         <table style="width: 379px; height: 83px;">
           <tr>
                 <td><asp:Label ID="lblNomeSensore" runat="server" style="position:absolute; left:290px; top:56px; width: 143px; height: 19px;" Font-Size="Large"></asp:Label>    </td>
                 <td><asp:Label ID="lblInterfaccia" runat="server" style="position:absolute; left:550px; top:56px; width: 84px; height: 19px;" Font-Size="Large"></asp:Label> </td>
            </tr>
             <tr>
                <td ><asp:Label ID="lblUnitàDiMisura" runat="server" style="position:absolute; left:290px; top:106px; width: 84px; height: 19px; " Font-Size="Large"></asp:Label> </td>
                 <td ><asp:Label ID="lblPendenza" runat="server" style="position:absolute; left:436px; top:106px; width: 84px; height: 19px; right: 1155px;" Font-Size="Large"></asp:Label></td>
                 <td> <asp:Label ID="lblValoraZero" runat="server" style="position:absolute; left:550px; top:106px; width: 84px; height: 19px;" Font-Size="Large"></asp:Label> </td>
            </tr>
